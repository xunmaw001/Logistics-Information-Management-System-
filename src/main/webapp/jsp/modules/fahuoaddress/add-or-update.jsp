    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑发货地址</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑发货地址</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">发货地址信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 fahuoaddressNameDiv">
                                        <label>发货人</label>
                                        <input style="width: 450px" id="fahuoaddressName" name="fahuoaddressName" class="form-control"
                                               placeholder="发货人">
                                    </div>
                                    <div class="form-group col-md-6 fahuoaddressPhoneDiv">
                                        <label>发货电话</label>
                                        <input style="width: 450px" id="fahuoaddressPhone" name="fahuoaddressPhone" class="form-control"
                                               onchange="fahuoaddressPhoneChickValue(this)"  placeholder="发货电话">
                                    </div>
                                    <div class="form-group col-md-6 fahuoaddressDizhiDiv">
                                        <label>发货地址</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("fahuoaddress/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addfahuoaddress');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function fahuoaddressPhoneChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                yonghuId: "required",
                fahuoaddressName: "required",
                fahuoaddressPhone: "required",
                fahuoaddressDizhi: "required",
            },
            messages: {
                yonghuId: "创建用户不能为空",
                fahuoaddressName: "发货人不能为空",
                fahuoaddressPhone: "发货电话不能为空",
                fahuoaddressDizhi: "发货地址不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addfahuoaddress = window.sessionStorage.getItem("addfahuoaddress");
        if (addfahuoaddress != null && addfahuoaddress != "" && addfahuoaddress != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("fahuoaddress/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
