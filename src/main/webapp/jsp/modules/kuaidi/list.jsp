...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">快递单号查询</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">快递单号列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">快递单号列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        单号
                                        <div class="layui-input-inline">
                                            <input type="text" id="kuaidiDanhaoSearch" style="width: 140px;" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //单号
            var kuaidiDanhaoSearchInput = $('#kuaidiDanhaoSearch');
            if( kuaidiDanhaoSearchInput != null){
                if (kuaidiDanhaoSearchInput.val() != null && kuaidiDanhaoSearchInput.val() != '') {
                    searchForm.kuaidiDanhao = $('#kuaidiDanhaoSearch').val();
                }
            }
        ...
        function getDataList() {
            http("kuaidi/page", "GET", {
                ...
                kuaidiDanhao: searchForm.kuaidiDanhao,
        ...
        function setDataRow(item, number) {
            ...
            //单号
            var kuaidiDanhaoCell = document.createElement('td');
            kuaidiDanhaoCell.innerHTML = item.kuaidiDanhao;
            row.appendChild(kuaidiDanhaoCell);
            ...
            //快递详情
            var kuaidiTextCell = document.createElement('td');
            kuaidiTextCell.innerHTML = item.kuaidiText;
            row.appendChild(kuaidiTextCell);
