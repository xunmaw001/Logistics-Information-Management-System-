...
<!--/Pre Loader -->
    ...
    <script>
        ...
        function getDataList() {
            http("shouhuoaddress/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                shouhuoaddressDelete: 1,
                //本表的
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("shouhuoaddress/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addshouhuoaddress", "addshouhuoaddress");
            window.location.href = "add-or-update.jsp"
        }
