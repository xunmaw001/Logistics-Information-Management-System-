                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 shouhuoaddressNameDiv">
                                        <label>收货人</label>
                                        <input style="width: 450px" id="shouhuoaddressName" name="shouhuoaddressName" class="form-control"
                                               placeholder="收货人">
                                    </div>
                                    <div class="form-group col-md-6 shouhuoaddressPhoneDiv">
                                        <label>收货电话</label>
                                        <input style="width: 450px" id="shouhuoaddressPhone" name="shouhuoaddressPhone" class="form-control"
                                               onchange="shouhuoaddressPhoneChickValue(this)"  placeholder="收货电话">
                                    </div>
                                    <div class="form-group col-md-6 shouhuoaddressDizhiDiv">
                                        <label>收货地址</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("shouhuoaddress/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addshouhuoaddress');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function shouhuoaddressPhoneChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                yonghuId: "required",
                shouhuoaddressName: "required",
                shouhuoaddressPhone: "required",
                shouhuoaddressDizhi: "required",
            },
            messages: {
                yonghuId: "创建用户不能为空",
                shouhuoaddressName: "收货人不能为空",
                shouhuoaddressPhone: "收货电话不能为空",
                shouhuoaddressDizhi: "收货地址不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addshouhuoaddress = window.sessionStorage.getItem("addshouhuoaddress");
        if (addshouhuoaddress != null && addshouhuoaddress != "" && addshouhuoaddress != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("shouhuoaddress/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
